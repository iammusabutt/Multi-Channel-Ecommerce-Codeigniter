	...
	<div class="content">
		...
		<!-- Page-Title -->
			...
			<?php echo form_open("admin/users/create_member", $attributes);?>
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card-box">
						<div class="row">
							<div class="col-12">
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.addgamer.submit()">Add User</a>
							</div>
						</div>
					</div>
				</div>
