				...
				<div class="col-sm-12">
					<div class="page-header-2">
						<ol class="breadcrumb pull-right mb-0">
							...
							<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/couriers">Couriers</a></li>
							<li class="breadcrumb-item active">Edit Courier</li>
						</ol>
						<h4 class="page-title">Edit Courier</h4>
						...
						<div class="card-box">
							<div class="row">
								<div class="col-12">
									...
									<a class="btn btn-default btn-gold waves-effect waves-light" onclick="document.new_city.submit()">Update</a>
								</div>
							</div><!-- end row -->
						</div> <!-- end card-box -->
					</div><!-- end col -->
