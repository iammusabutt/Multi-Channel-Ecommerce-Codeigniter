	...
	<div class="content">
		...
		<!-- Page-Title -->
			...
			<?php $attributes = array('class' => 'form-horizontal', 'name' => 'edit_shipper');?>
			<?php echo form_open($this->uri->segment(1). "/shippers/edit_shipper/". $user['id'], $attributes);?>
			<div class="row">
				<div class="col-lg-9 col-md-9 col-sm-12">
					<div class="card-box">
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group row">
									<label for="shipper_term_conditions" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Terms $ Conditions <span class="text-danger">*</span></label>
									<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card-box">
						<div class="row">
							<div class="col-12">
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.edit_shipper.submit()">Update Shipper</a>
							</div>
						</div>
					</div>
				</div>
