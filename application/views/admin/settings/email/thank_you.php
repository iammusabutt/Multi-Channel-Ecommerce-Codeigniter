					...
					<div class="col-9">
						<div class="card-box">
							<div class="row">
								<div class="col-12">
									...
									<div class="form-group row">
										<label for="subject" class="col-12 col-form-label">Admin Email Subject <span class="text-danger">*</span></label>
										<div class="col-12">
						...
						<div class="card-box">
							<div class="row">
								<div class="col-12">
									<div class="form-group row">
										<label for="subject" class="col-12 col-form-label">Customer Email Subject <span class="text-danger">*</span></label>
										<div class="col-12">
											<?php echo form_input($receiver_subject);?>
										</div>
									</div>
								</div>
							</div><!-- end row -->
