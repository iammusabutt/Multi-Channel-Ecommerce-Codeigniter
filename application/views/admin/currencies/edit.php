							...
							<div class="row">
								<div class="col-12">
									<div class="form-group row">
										<label for="currency_name" class="col-lg-12 col-md-12 col-sm-12 col-form-label">City <span class="text-danger">*</span></label>
										<div class="col-lg-12 col-md-12 col-sm-12">
											<?php echo form_input($currency_name);?>
										</div>
									</div>
									<div class="form-group row">
										<label for="currency_code" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Country <span class="text-danger">*</span></label>
										<div class="col-lg-12 col-md-12 col-sm-12">
											<?php echo form_input($currency_code);?>
										</div>
									</div>
									<div class="form-group row">
										<label for="currency_symbol" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Code</label>
										<div class="col-lg-12 col-md-12 col-sm-12">
