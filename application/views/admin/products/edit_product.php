			...
			<div class="row">
				<div class="col-sm-12">
					<div class="page-header-2">
						...
						<a href="<?php echo base_url();?>admin/products/add_product?post_type=product" class="btn btn-gold waves-effect waves-light">Add New</a>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="v-attributes">
									<div class="row">
										...
										<div class="col-6">
											<a href="#" id="select_attribute" data-object-id="<?php echo $this->uri->segment(4);?>" class="btn btn-gold waves-effect waves-light">Add</a>
										</div>
									</div>
									<hr>
												...
												<span href="#<?php echo $block['attribute_slug'];?>" class="text-dark anchor-arch" data-toggle="collapse" aria-expanded="true" aria-controls="<?php echo $block['attribute_slug'];?>">
													<h6 class="m-0">
														<small class="text-muted">
															<a id="delete_attribute" data-object-id="<?php echo $this->uri->segment(4);?>" data-attributevalue="<?php echo $block['attribute_slug'];?>" class="remove_row delete text-danger">Remove</a>
														</small>
									...
									<div class="row">
										<div class="col-12">
											<a id="save_attribute" data-object-id="<?php echo $this->uri->segment(4);?>" class="btn btn-gold waves-effect waves-light">Save attributes</a>
										</div>
									</div>
								</div>
								<div class="tab-pane" id="v-variations">
									<div class="row">
										...
										<div class="col-6">
											<a id="add_variation" data-object-id="<?php echo $this->uri->segment(4);?>" class="btn btn-gold waves-effect waves-light">Go</a>
										</div>
									</div>
									<hr>
										...
										<div class="col-lg-12">
											<div class="card-header single-row p-0" id="heading<?php echo $variation['object_id'];?>">
												...
												<span href="#collapse<?php echo $variation['object_id'];?>" class="text-dark anchor-vari" data-target="#collapse<?php echo $variation['object_id'];?>" data-toggle="collapse" aria-controls="collapse<?php echo $variation['object_id'];?>">
													<h6 class="m-0">
														<small class="text-muted">
															<a id="delete_variation" data-object-id="<?php echo $this->uri->segment(4);?>" data-variation-id="<?php echo $variation['object_id'];?>" class="remove_row delete text-danger m-t-5">Remove</a>
														</small>
													</h6>
												</span>
											</div>
									...
									<div class="row">
										<div class="col-12">
											<a id="save_variation" data-object-id="<?php echo $this->uri->segment(4);?>" class="btn btn-gold waves-effect waves-light">Save variation</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="portlet">
						<div class="portlet-heading bg-gold p-t-0 p-b-0">
							<div class="portlet-widgets portlet-header-sm">
								<a data-toggle="collapse" data-parent="#accordion1" href="#bg-categories">
									<h6 class="pull-left text-white m-0 m-r-10 l-h-34">Categories</h6>
						...
						<div id="bg-categories" class="panel-collapse collapse show">
							<div class="portlet-body">
								<a class="label label-success btn-default" href="<?php echo base_url();?>admin/products/categories">Add new category</a>
								<div class="mt-3">
