						...
						<div class="table-responsive">
							<table id="datatable" class="table table-hover mails m-0 table table-actions-bar">
								...
								<tr class="action-row">
									...
									<td>
										<a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/products/edit_product/<?php echo $product['object_id'];?>"><?php echo $product['object_title'];?></a>
										<small id="emailHelp" class="form-text text-muted action-links">
										<a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/products/details/<?php echo $product['object_id'];?>" class="text-success">details</a> | <a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/products/edit_product/<?php echo $product['object_id'];?>" class="text-primary">edit</a> | <a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/products/delete_product/<?php echo $product['object_id'];?>" class="text-danger">delete</a> | <a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/products/product_vendors/<?php echo $product['object_id'];?>" class="text-info">vendors</a>
										</small>
									</td>
