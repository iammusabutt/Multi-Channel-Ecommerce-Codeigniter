				...
				<div class="col-sm-12">
					<div class="page-header-2">
						<ol class="breadcrumb pull-right mb-0">
							<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/products/attributes">Attribute</a></li>
							<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/products/attribute_values?taxonomy=<?php echo $attribute['attribute_slug'];?>">Values</a></li>
