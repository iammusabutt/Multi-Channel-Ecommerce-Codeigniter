				...
				<div class="col-sm-12">
					<div class="page-header-2">
						<ol class="breadcrumb pull-right mb-0">
							<li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/products/attributes">Attributes</a></li>
											...
											<tr class="action-row">
												<td>
													...
													<small id="emailHelp" class="form-text text-muted action-links">
														<a href="<?php echo base_url();?>admin/products/attribute_values?taxonomy=<?php echo $attribute['attribute_slug'];?>&action=edit&term_id=<?php echo $taxonomy['term_id'];?>" class="text-primary">edit</a> | <a href="<?php echo base_url();?>admin/products/attribute_values?taxonomy=<?php echo $attribute['attribute_slug'];?>&action=delete&term_id=<?php echo $taxonomy['term_id'];?>" class="text-danger">delete</a>
													</small>
												</td>
