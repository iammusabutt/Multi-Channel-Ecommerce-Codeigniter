			...
			<div class="row">
				<div class="col-sm-12">
					<div class="page-header-2">
						...
						<a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/vendors/create_vendor" class="btn btn-gold waves-effect waves-light">New Vendor</a>
						<div class="clearfix"></div>
					</div>
				</div>
			</div>
			<div id="infoMessage"><?php echo $message;?></div>
			<?php $attributes = array('class' => 'form-horizontal', 'name' => 'create_vendor');?>
			<?php echo form_open($this->uri->segment(1). "/vendors/create_vendor", $attributes);?>
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card-box">
						<div class="row">
							<div class="col-12">
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.create_vendor.submit()">Add Vendor</a>
							</div>
						</div>
					</div>
				</div>
