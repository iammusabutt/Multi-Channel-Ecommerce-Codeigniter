	...
	<div class="content">
		...
		<!-- Page-Title -->
			<div class="row">
				<div class="col-sm-12">
					<div class="page-header-2">
						...
						<h4 class="page-title">Create New Member</h4>
			...
			<?php echo form_open("admin/members/create_member", $attributes);?>
			<div class="row">
				<div class="col-lg-9 col-md-9 col-sm-12">
					<div class="card-box">
						...
						<div class="row">
							<div class="col-6">
								<div class="form-group row">
									<label for="share_percentage" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Company <span class="text-danger">*</span></label>
									<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card-box">
						<div class="row">
							<div class="col-12">
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.addgamer.submit()">Add Member</a>
							</div>
						</div>
					</div>
				</div>
