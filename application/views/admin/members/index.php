									...
									<tr class="action-row">
										<td>
											...
											<small id="emailHelp" class="form-text text-muted action-links">
												<a href="<?php echo base_url();?>admin/members/edit_member/<?php echo $user->id;?>" class="text-primary">edit</a> | <a href="<?php echo base_url();?>admin/members/delete_member/<?php echo $user->id;?>" class="text-danger">delete</a>
											</small>
										</td>
