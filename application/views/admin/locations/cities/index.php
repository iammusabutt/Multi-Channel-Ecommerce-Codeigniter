					...
					<div class="col-lg-5 col-md-5 col-sm-12">
						<div class="card-box">
							<div class="row">
								...
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.new_city.submit()">Publish</a>
								</div>
							</div><!-- end row -->
						</div> <!-- end card-box -->
					</div><!-- end col -->
									...
									<table id="datatable" class="table table-hover mails m-0 table table-actions-bar">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo anchor("admin/locations/edit_city/".$city->city_id, '<i class="md md-edit"></i>', 'class="table-action-btn"') ;?><?php echo anchor("admin/locations/delete_city/".$city->city_id, '<i class="md md-delete"></i>', 'class="table-action-btn"') ;?></td>
											</tr>
											<?php endforeach; else:?>
											<tr>
