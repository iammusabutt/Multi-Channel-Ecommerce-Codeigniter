									...
									<div class="form-group row">
										...
										<div class="col-12">
											<select name="continent_id" class="selectpicker" data-live-search="true"  data-style="btn-white">
												<option class="option-disabled" selected="true" value="<?php echo $single_continent['continent_id'];?>"><?php echo $single_continent['continent_name'];?></option>
											<?php if(!empty($all_continents)): foreach ($all_continents as $continent): ?>
												<option value="<?php echo $continent->continent_id;?>"><?php echo $continent->continent_name;?></option>
												<?php endforeach; else:?>
