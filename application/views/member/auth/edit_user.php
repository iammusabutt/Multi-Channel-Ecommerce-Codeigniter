	...
	<div class="content">
		...
		<!-- Page-Title -->
			...
			<?php $attributes = array('class' => 'form-horizontal', 'name' => 'member_details');?>
			<?php echo form_open("admin/members/edit_member/". $user->id, $attributes);?>
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card-box">
						<div class="row">
							<div class="col-12">
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.member_details.submit()">Update Member</a>
							</div>
						</div>
					</div>
				</div>
