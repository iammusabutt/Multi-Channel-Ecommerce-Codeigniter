	...
	<div class="content">
		...
		<!-- Page-Title -->
			...
			<?php $attributes = array('class' => 'form-horizontal', 'name' => 'edit_user');?>
			<?php echo form_open($this->uri->segment(1)."/users/edit_user/". $member['id'], $attributes);?>
			<div class="row">
						...
						<div class="row">
							<div class="col-6">
								<div class="form-group row">
									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										<select name="marketplace_id" class="selectpicker" data-style="btn-white">
				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card-box">
						<div class="row">
							<div class="col-12">
								<a class="btn btn-gold btn-block waves-effect waves-light" onclick="document.edit_user.submit()">Update Account</a>
							</div>
						</div>
					</div>
				</div>
	...
	<script>
	$('select[name=store_type]').val('<?php echo $member_metadata['store_type'];?>');
	$('select[name=marketplace_id]').val('<?php echo $member_metadata['marketplace_id'];?>');
	$('select[name=country_id]').val('<?php echo $member_metadata['country_id'];?>');
	$('select[name=currency_id]').val('<?php echo $member_metadata['currency_id'];?>');
