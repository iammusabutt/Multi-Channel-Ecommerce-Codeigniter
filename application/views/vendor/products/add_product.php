...
<!-- Start content -->
	<div class="content">
		...
		<!-- Page-Title -->
				...
				<div class="col-sm-12">
					<div class="page-header-2">
						<ol class="breadcrumb pull-right mb-0">
							<li class="breadcrumb-item"><a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>?post_type=product">Products</a></li>
							<li class="breadcrumb-item active">Add Product</li>
						</ol>
						<h4 class="page-title">Add Product</h4>
						<a href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>?post_type=product" class="btn btn-gold waves-effect waves-light">Add New</a>
			...
			<?php echo form_open(uri_string() . "?post_type=product&&action=add", $attributes);?>
