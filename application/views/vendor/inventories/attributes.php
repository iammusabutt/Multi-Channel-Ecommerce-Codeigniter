											...
											<tr class="action-row">
												<td>
													...
													<small id="emailHelp" class="form-text text-muted action-links">
														<a href="<?php echo base_url();?>vendors/products/edit_attribute/<?php echo $block['attribute_id'];?>" class="text-primary">edit</a> | <a href="<?php echo base_url();?>vendors/products/delete_attribute/<?php echo $block['attribute_id'];?>" class="text-danger">delete</a>
													</small>
												</td>
												...
												<td><a href="<?php echo base_url();?>vendors/products/attribute_values?taxonomy=<?php echo $block['attribute_slug'];?>" class="btn btn-block btn-gold waves-effect waves-light btn-sm">configure <?php echo $block['attribute_slug'];?></a></td>
											</tr>
											<?php endforeach; else:?>
											<tr>
