                ...
                <nav class="navbar-custom">
                    <ul class="list-inline float-right mb-0">
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" href="<?php echo base_url();?><?php echo $this->uri->segment(1);?>/notifications">
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                                ...
                                <!-- item-->
                                <a href="<?php echo base_url();?>vendor/change_password" class="dropdown-item notify-item">
                                    <i class="md md-lock-outline"></i> <span>Change Password</span>
                                </a>

                                <!-- item-->
                                <a href="<?php echo base_url();?>vendor/logout" class="dropdown-item notify-item">
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="<?php echo base_url();?>vendor/dashboard" class="waves-effect"><i class="ti-dashboard"></i><span> Dashboard </span> </a>
							</li>
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url();?>vendor/orders">View Orders</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="ti-package"></i> <span> Products </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url();?>vendor/products?post_type=product">Products</a></li>
                                    <li><a href="<?php echo base_url();?>vendor/products?post_type=product&&action=add">Add Product</a></li>
                                    <li><a href="<?php echo base_url();?>vendor/inventories">Inventory</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url();?>vendor/warehouses">Warehouses</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="ti-settings"></i> <span> Settings </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo base_url();?>vendor/auth/change_password">Change Password</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>vendor/logout" class="waves-effect"><i class="ti-home"></i><span> Logout </span> </a>
							</li>
                        </ul>
