			...
			<div class="row">
				<div class="col-sm-12">
					<div class="page-header-2">
						...
						<a href="<?php echo base_url();?>admin/members/create_member" class="btn btn-default waves-effect waves-light">Create New Member</a>
							...
							<table id="datatable" class="table table-hover mails m-0 table table-actions-bar">
								...
								<?php foreach ($users as $user):?>
									<tr>
										...
										<td><a href="<?php echo base_url();?>admin/members/member_detail/<?php echo $user->id;?>" class="btn btn-block btn-success waves-effect waves-light">View Details</a></td>
									</tr>
								<?php endforeach;?>
								</tbody>
							</table>
