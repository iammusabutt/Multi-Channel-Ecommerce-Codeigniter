        ...
        <div class="wrapper-page">
            <div class="card-box">
                <ul class="nav nav-pills navtab-bg nav-justified">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url()?>user/login" class="nav-link text-inverse">
                            User
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url()?>shipper/login" class="nav-link btn-gold active">
                            Shipper
                        </a>
                    </li>
                </ul>
                <div class="panel-heading m-t-30">
                    <h4 class="text-center"><strong class="text-custom">Shipper Login</strong></h4>
                </div>
