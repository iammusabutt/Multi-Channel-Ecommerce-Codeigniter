		...
		var table = $('#empTable').DataTable({
	      	...
	      	'columns': [
				...
				{ data: 'object_date' },
	         	...
	         	{ 
					render : function(data, type, row) {
							return '<a href="'+base_url+account_type+'/orders/add_tracking/'+row.object_id+'" class="btn btn-icon waves-effect waves-light btn-gold"><i class="ti-truck"></i></a> <a id="update_tracking_status" data-style="zoom-in" data-object-id="'+row.object_id+'" data-order-id="'+row.object_id+'" data-tracking-number="'+row.tracking_number+'" class="btn btn-gold waves-effect waves-light">Track</a>';
          			},
				},
	      	],
