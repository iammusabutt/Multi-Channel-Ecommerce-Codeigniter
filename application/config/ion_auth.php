...
$config['message_start_delimiter'] = '<p class="btn btn-success waves-effect waves-light">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="btn btn-danger waves-effect waves-light">';		// Error message start delimiter
