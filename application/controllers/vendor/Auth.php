...
class Auth extends Vendor_Controller
{
	...
	public function index()
	{
		if (!$this->ion_auth->logged_in())
		{
			...
			redirect('vendor/auth/login', 'refresh');
		}
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			else
			{
				...
				redirect('vendor/auth/login', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
			...
			$this->load->view('vendor/auth/login', $this->data);
		}
	}
	...
	public function change_password()
	{
		...
		else
		{
			...
			{
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				redirect('vendor/auth/change_password', 'refresh');
			}
		}
	}
