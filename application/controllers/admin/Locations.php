	...
	public function edit_country($country_id = NULL)
	{
		...
		else
		{
			...
			if(!empty($country))
			{
				...
				//echo '<pre>'; print_r($single_continent); echo '</pre>'; die();
				$this->data['continent_id'] = array(
					'name' => 'continent_id',
					'id' => 'continent_id',
					'type' => 'text',
					'value' => $this->form_validation->set_value('continent_id', !empty($single_continent['continent_id']) ? $single_continent['continent_id'] : ""),
					'class' => 'form-control',
					'placeholder' => 'Enter any stopover',
				);
				$this->data['country_code'] = array(
