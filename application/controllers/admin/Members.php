...
class Members extends Backend_Controller
{
	...
	public function index()
	{
		...
		else
		{
			...
			$this->_render_page('admin' . DIRECTORY_SEPARATOR . 'members' . DIRECTORY_SEPARATOR . 'index', $this->data);
		}
	}
	...
	public function create_member()
	{
		...
		$this->_render_page('admin' . DIRECTORY_SEPARATOR . 'members' . DIRECTORY_SEPARATOR . 'create_member', $this->data);
	}
	...
	public function edit_member($id)
	{
		...
		$this->data['message'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message')));
		$this->_render_page('admin' . DIRECTORY_SEPARATOR . 'members' . DIRECTORY_SEPARATOR . 'edit_member', $this->data);
	}
